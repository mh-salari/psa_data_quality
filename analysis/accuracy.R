...
# Create the plot
p <- ggplot(accuracy_df, aes(x = eye_tracker, y = accuracy, fill = trial_condition)) +
  # Add boxplots
...
# Save the plot
ggsave("./output/naccuracy.png", plot = p, width = 10, height = 7, dpi = 300, bg = "transparent")
